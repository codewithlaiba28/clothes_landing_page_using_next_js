                ...
                <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-16">
                    ...
                    <div>
                        ...
                        <ul className="space-y-4 text-sm text-muted">
                            <li><Link href="#" className="hover:text-secondary transition-colors">New Arrivals</Link></li>
                            <li><Link href="#" className="hover:text-secondary transition-colors">Best Sellers</Link></li>
                            <li><Link href="#" className="hover:text-secondary transition-colors">Clothing</Link></li>
                    ...
                    <div>
                        ...
                        <ul className="space-y-4 text-sm text-muted">
                            ...
                            <li><Link href="#" className="hover:text-secondary transition-colors">Our Stores</Link></li>
                    ...
                    <div>
                        ...
                        <form className="flex flex-col gap-3">
                            <input
                                ...
                                className="bg-transparent border-b border-muted py-2 text-sm focus:outline-none focus:border-secondary transition-colors placeholder:text-muted/50"
                            />
                            <Button className="w-full bg-secondary text-primary hover:bg-white mt-2 rounded-none">
                                Subscribe
                            </Button>
                        </form>
                    </div>
